...
public class StockDataDisposeTest {
	...
	public void testGetStockList() throws Exception {
		Map l2014 = stockDataDispose.getStockList("2014",Location.sh);
		Map l2015 = stockDataDispose.getStockList("2015",Location.sh);
	...
	@Test
	public void testGetStockMessage() throws Exception {
