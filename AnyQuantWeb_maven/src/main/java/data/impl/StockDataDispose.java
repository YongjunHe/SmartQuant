...
//		return dateMessage;
	...
	public static void main(String[]args){
		...
		StockDisposeService service = new StockDataDispose();
		try {
			List list = service.getStockMessage("sh600066", "2016-05-10", "2016-06-10");
	...
	private String idProcess(String idNumber){
		...
		if(Integer.valueOf(idNumber) >= 600000 || Integer.valueOf(idNumber) == 300)
			result = "sh" + idNumber;
		else
			result =  "sz" + idNumber;
		return result;
