...
import logic.service.StockCheckService;
...
//		return stock.getAllDateMessage();
	...
	public Iterator<Stock> getSelectedStock() throws Exception {
		...
		return stockDataDispose.getSelectStockList().values().iterator();
	}
...
//		return marketStock.get(Location.valueOf(idNumber.substring(0, 2))).get(idNumber).getCName();
	    ...
	    return stockDataDispose.getCName(idNumber);
	}
	...
	public Iterator<Stock> getStockMessageByCName(String CName) {
		// TODO Auto-generated method stub
		return stockDataDispose.getStockMessageWithCName(CName);
	}
