...
public class StockDateNode implements NodeService,Comparable<StockDateNode>,Serializable{
	...
	public double getType(DataType sortType) {
		...
		if(typeNumber == null){
			...
			typeNumber = new double[] {volume,pb,high,adj_price,low,Double.valueOf(result),close,open,turnover};
		}
